...
import json
from sample_tracker import get_chrome_web_driver, get_web_driver_options, set_browser_as_incognito
from sample_tracker import set_ignore_certificate_error
from sample_tracker import NAME, CURRENCY, BASE_URL, FILTERS, DIRECTORY
...
class AmazonAPI:
    ...
    def get_single_product_info(self, asin):
        print(f"Product_ID :{asin} - getting data....")
